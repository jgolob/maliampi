...
class Workflow_Placement(sl.WorkflowTask):
    ...
    def workflow(self):
        ...
        refpkg_alignments.in_refpkg_tgz = refpkg_tgz.out_file
        ...
        dedup_jplace.in_refpkg_tgz = refpkg_tgz.out_file
        ...
        epca.in_refpkg_tgz = refpkg_tgz.out_file
        ...
        lpca.in_refpkg_tgz = refpkg_tgz.out_file
